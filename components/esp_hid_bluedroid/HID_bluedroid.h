...
/* use this to do things when a device is connected */
extern void do_when_ble_hid_connect(void);
/* use this to do things when a device is disconnected */
extern void do_when_ble_hid_disconnect(void);
/* use this to do things when a device is stopped */
extern void do_when_ble_hid_stop(void);
